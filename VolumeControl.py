...
import time
import numpy as np
from CV_Desktop import HandsGestureDetector as htm
import math
...
warnings.filterwarnings('ignore', category=FutureWarning, message='Feedback manager requires a model with a single signature inference. Disabling support for feedback tensors.')
